...
export default function WhatsAppFloat() {
  return (
    <div className="fixed bottom-6 right-5 z-50" role="complementary" aria-label="Agendar pelo WhatsApp">
      {/* Pulse rings */}
      <span className="absolute inset-0 rounded-full bg-green-500/30 animate-ping" />
      <span className="absolute inset-0 rounded-full bg-green-500/20 animate-ping" style={{ animationDelay: '0.5s' }} />
